...
def main():
    ...
    parser.add_argument("-model", required=True, type=str,
                        help=f"{'PATH':<15}{'absolute path to the raxml-ng model file (.bestModel)':^50}")
    parser.add_argument("-query", required=True, type=str,
                        help=f"{'PATH':<15}{'absolute path to the query file in .fasta format':^50}")
    ...
    parser.add_argument("-raxmlng", required=False, type=str, default="raxml-ng",
                        help=f"{'PATH':<15}{'path to RAxML-NG':^50}{'| default: raxml-ng':>20}")
